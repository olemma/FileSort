...
CONFIG_DIR=$( test -z $1 && echo "/home/jimbo/.config/deluge" || echo "$1")
...
/home/jimbo/.local/share/virtualenvs/deluge-agzFmveA/bin/python setup.py build develop --install-dir $BASEDIR/temp
